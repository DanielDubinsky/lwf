...
from src.visualization.misc_functions import recreate_image, save_image
...
class RegularizedClassSpecificImageGeneration():
    ...
    def __init__(self, model, target_class):
        ...
        self.std = [1/0.2023, 1/0.1994, 1/0.2010]
    ...
    def generate(self, iterations=150, blur_freq=4, blur_rad=1, wd=0.0001, clipping_value=0.1):
        ...
        for i in range(1, iterations):
            ...
            # Forward
            output, _ = self.model(self.processed_image)
            ...
            optimizer.step()
            # Recreate image
            self.created_image = recreate_image(self.processed_image.cpu(), self.mean, self.std)
...
if __name__ == '__main__':
    ...
    target_class = 1 
    pretrained_model = load_model('./lwf_28_s0.pth')
